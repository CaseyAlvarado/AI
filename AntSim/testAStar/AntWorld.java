 ...
 *  
 * Each cell has a state. One cell can be defined as the 'start' and one or more cells ca n be labeled as goals, and these goals might be dynamic. 
 * 
...
public class AntWorld extends PApplet {
	...
	public void draw() {
		...
		if (endRun()) {
			...
			if (run == (numRuns - 1)) {
				runBest[run][0] = run;  
				runBest[run][1] = bestPathLength; 
				dsp = new DataSetPlot(runBest); 
				dsp.setTitle("Alg A*" +  "/" + "Mean:" + calculateMeanForRunBest() + "/" + "Standard Deviation:" + calculateStandardDeviation()); 
				...
				jp.setTitle("A* Best Path Length for 50 runs"); 
...
//	}
	...
	public static void main(String[] args) {
		...
		PApplet.main(new String[] { "testAStar.AntWorld" });
	}
}
